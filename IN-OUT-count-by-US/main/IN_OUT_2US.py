...
ECHO_PIN_A = 3
TRIGGER_PIN_B = 14 # Ultrasonic Sensor B (Exit)
ECHO_PIN_B = 15
MAX_CAPACITY = 5
...
GREEN_LED_PIN = machine.Pin(6, machine.Pin.OUT)
RED_LED_PIN = machine.Pin(7, machine.Pin.OUT)
...
# Function to sound the buzzer continuously for 3 seconds
def sound_buzzer_3_seconds():
    end_time = utime.time() + 2
